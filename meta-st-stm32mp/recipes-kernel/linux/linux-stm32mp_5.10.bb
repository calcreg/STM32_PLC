...
KERNEL_CONFIG_FRAGMENTS += "${WORKDIR}/fragments/${LINUX_VERSION}/fragment-06-dmcrypt-drm.config"
...
SRC_URI += "file://${LINUX_VERSION}/fragment-06-dmcrypt-drm.config;subdir=fragments"
...
#SRC_URI_class-devupstream += "file://${LINUX_VERSION}/fragment-06-dmcrypt-drm.config;subdir=fragments"
